...
class AcademicActivity : AppCompatActivity() {
    ...
    private fun setupScrollAnimations() {
        val scrollView = findViewById<NestedScrollView>(R.id.academicScrollView)
        val contentLayout = findViewById<LinearLayout>(R.id.academicContentLayout)
